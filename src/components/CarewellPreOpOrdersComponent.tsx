          ...
          <div className="border-2 border-black p-6 space-y-4 max-w-4xl mx-auto text-black">
            ...
            <div className="text-center border-b-2 border-black pb-3 space-y-1">
              <div className="flex items-center justify-center">
                <span className="text-[10px] font-bold uppercase">NEO GASTRO HOSPITAL</span>
              </div>
              <h1 className="text-xl font-bold uppercase tracking-tight">NEO GASTRO HOSPITAL</h1>
