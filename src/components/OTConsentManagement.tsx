            ...
            <table class="header-table">
              <tr>
                <td style="width: 72%; vertical-align: top;">
                  <h1 class="hospital-title">NEO GASTROPLUS HOSPITAL</h1>
                  <p class="hospital-sub">Infront of Aura Inn, Bansi Road near Badewan, Basti UP 272001 &bull; Ph: +91 8601561055</p>
