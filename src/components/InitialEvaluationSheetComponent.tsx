...
export const InitialEvaluationSheetComponent: React.FC<InitialEvaluationSheetProps> = ({
  ...
  const hospitalName = rawHospitalInfo?.name || 'GastroPlus Hospital';
  const hospitalSub = rawHospitalInfo?.subHeader || 'Neo GastroPlus Hospital (A unit of GP Healthcare)';
  const hospitalAddress = rawHospitalInfo?.address || 'Shop No. 10, Om Shiv Nagar, Gufa Mandir Road, Lalghati, Bhopal, 462032 (M.P.)';
  const hospitalPhone = rawHospitalInfo?.phone || '+91-0109101245,46';
