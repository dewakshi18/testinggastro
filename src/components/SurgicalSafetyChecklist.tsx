      ...
      <html>
        ...
        <body>
          <table class="header-table">
            <tr>
              <td style="width: 70%;">
                <h1 class="hospital-name">NEO GASTRO HOSPITAL</h1>
                <div style="font-size: 10px; font-weight: bold; margin-top: 2px; color: #333;">CMHO Reg. & License No.: NH327/DEC/2027</div>
                <div style="font-size: 9px; font-weight: bold; margin-bottom: 3px; color: #555;">Infront of Aura Inn, Bansi Road near Badewan, Basti UP 272001 | Ph: +91-8601561055</div>
              </td>
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
            <div className="space-y-1">
              <div className="flex items-center gap-2">
                ...
                <DialogTitle className="text-xl font-black tracking-tight">Neo Gastro Hospital — Surgical Safety Record</DialogTitle>
              </div>
