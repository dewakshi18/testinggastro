      ...
      <html>
        ...
        <body>
          <div class="header-box">
            <div class="h-title">NEO GASTROPLUS HOSPITAL</div>
            <div class="sub-title">Infront of Aura Inn, Bansi Road near Badewan, Basti UP 272001 | Ph.: +918601561055</div>
          </div>
            ...
            <div className="border-2 border-slate-900 p-4 rounded-xl space-y-4 bg-slate-50/50 print:border-black">
              <div className="flex flex-col items-center justify-center text-center pb-3 border-b-2 border-slate-800">
                <div className="flex items-center gap-2 text-slate-900 font-black text-xl tracking-tight">
                  ...
                  <span>NEO GASTROPLUS HOSPITAL</span>
                </div>
                <p className="text-xs text-slate-700 font-semibold mt-0.5">
                  Infront of Aura Inn, Bansi Road near Badewan, Basti UP 272001 | Ph.: +918601561055
                </p>
          ...
          <div className="border-2 border-black p-6 space-y-4 max-w-4xl mx-auto">
            ...
            <div className="text-center border-b-2 border-black pb-3 space-y-1">
              <div className="flex items-center justify-center">
                <span className="text-[10px] font-bold uppercase tracking-wider">NEO GASTROPLUS HOSPITAL</span>
              </div>
              <h1 className="text-xl font-bold uppercase tracking-tight">NEO GASTROPLUS HOSPITAL</h1>
              <p className="text-[10px] italic">Infront of Aura Inn, Bansi Road near Badewan, Basti UP 272001 | Ph.: +918601561055</p>
            </div>
