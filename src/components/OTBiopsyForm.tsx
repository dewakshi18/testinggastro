  ...
  const printBiopsySlip = (req: OTBiopsyRequisition) => {
    ...
    printWindow.document.write(`
      <html>
        ...
        <body>
          <div class="header">
            <div style="font-size: 22px; font-weight: 900; color: #000000 !important;">NEO GASTROPLUS HOSPITAL</div>
            <div style="font-weight: 800; color: #000000 !important;">Infront of Aura Inn, Bansi Road near Badewan, Basti UP 272001 | Ph: +918601561055</div>
