...
import { MOCK_USERS, MOCK_THEATRES } from '@/mockData';
...
const OT_TAB_ITEMS: OTTabItem[] = [
  ...
  {
    id: 'theatres',
    label: 'OT Status & Rooms',
    shortLabel: 'OT Status',
    category: 'core',
    categoryName: 'Core OT Workflows',
    icon: Activity,
    badge: '4. Live OT',
          ...
          <div className="space-y-2">
            ...
            <div className="flex flex-wrap items-center gap-2 pt-2">
              ...
              <div className="flex items-center gap-2 px-3 py-1.5 rounded-xl bg-blue-500/20 backdrop-blur-sm border border-blue-400/30 text-xs">
                ...
                <span className="text-blue-200 font-medium">Forms & Sheets:</span>
