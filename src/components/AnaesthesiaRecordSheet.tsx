            ...
            <table class="header-table">
              <tr>
                <td style="width: 15%; text-align: left;">
                  <div style="border: 2px solid #000; border-radius: 50%; width: 42px; height: 42px; display: flex; align-items: center; justify-content: center; font-weight: bold; font-size: 8pt; text-align: center;">NGH</div>
                </td>
                <td style="width: 70%;">
                  <div class="hospital-title">NEO GASTRO HOSPITAL</div>
                  <div class="hospital-sub">CMHO Reg. & License No.: NH327/DEC/2027</div>
                  <div class="hospital-sub">Infront of Aura Inn, Bansi Road near Badewan, Basti UP 272001 &bull; Ph: +91 8601561055</div>
                </td>
