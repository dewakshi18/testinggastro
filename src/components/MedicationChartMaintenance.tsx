...
export default function MedicationChartMaintenance({ patientId: propPatientId, patient: propPatient, embedded = false }: Props) {
  ...
  const printDailyTreatmentSheet = () => {
    ...
    const hospName = hospInfo?.name || 'Neo Gastroplus Hospital';
    const hospAddr = hospInfo?.address || 'Infront of Aura Inn, Bansi Road near Badewan, Basti UP 272001';
    const hospPhone = hospInfo?.phone || '+918601561055';
    const hospEmail = hospInfo?.email || 'info@neogastroplushospital.com';
