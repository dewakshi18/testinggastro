...
export function getPathologyReportHtml(
  ...
  const hospName = hospitalInfo?.name || 'NEO GASTRO HOSPITAL';
  const hospAddress = hospitalInfo?.address || 'Infront of Aura Inn, Bansi Road near Badewan, Basti UP 272001';
  const hospPhone = hospitalInfo?.phone || '+91 86015 61055';
